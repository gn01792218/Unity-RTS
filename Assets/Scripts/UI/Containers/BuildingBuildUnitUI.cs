...
//建築物單位的可以建造unit選單，應該名為BuildingBuildUnitUI
public class BuildingBuildUnitUI : MonoBehaviour, IUIElement<BuildingUnit>
{
    ...
    private void HandleQueueUpdated(UnitSO[] unitsInQueue)
    {
        ...
        if(currentBuilding != null) SetupCancelButtons(); //更新那些按下去後可被取消的Unit按鈕
    }
